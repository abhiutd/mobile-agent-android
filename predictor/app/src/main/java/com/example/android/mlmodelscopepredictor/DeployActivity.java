...
public class DeployActivity extends AppCompatActivity {
    ...
    public DeployAdapter deployAdapter;
            ...
            public void call(final Object... args) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(DeployActivity.this,data,Toast.LENGTH_SHORT).show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            deployAdapter = new DeployAdapter(MessageList);
                            ...
                            myRecylerView.setAdapter(deployAdapter);
